<template>
  <div>
    <header class="legacy-presentation">
      <img src="images/qiskit-logo.svg" alt="Welcome to Quantum logo">
      <div>
        <h1>Welcome to Quantum</h1>
        <p>Qiskit is an open-source quantum computing software development framework for leveraging today's quantum processors in research, education, and business.</p>
        <Cta to="https://qiskit.org/documentation/install.html">
          Get Started!
        </Cta>
      </div>
    </header>
    <section class="legacy-section news">
      <div>
        <article>
    ...
    <section class="legacy-section legacy-section--colored">
      <div>
        <article>
